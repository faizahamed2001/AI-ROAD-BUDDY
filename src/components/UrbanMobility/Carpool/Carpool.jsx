  ...
  return (
    <div className="carpool-outer">
      ...
      <div className="carpool-container">
        <h2 style={{marginBottom: '20px'}}><FaCarSide style={{marginRight: '8px'}} />Find a Carpool Buddy</h2>
        <form className="carpool-inputs" style={{display:'flex',flexWrap:'wrap',gap:'0.75rem',marginBottom:'1rem'}} onSubmit={e => {e.preventDefault(); setSearch(true);}}>
          <input
            ...
            style={{flex:'1 1 100px', minWidth:70, maxWidth:150, fontSize:'0.95em', padding:'6px'}}
            required
          />
          <input
            className="carpool-input"
          ...
          <input
            className="carpool-input seats"
            type="number"
            placeholder="Seats Available"
            value={seats}
            onChange={e => setSeats(e.target.value)}
            min={1}
            style={{minWidth:50, maxWidth:150, fontSize:'0.95em', padding:'6px'}}
            required
          />
          <input
            className="carpool-input"
            ...
            style={{flex:'1 1 70px', minWidth:50, maxWidth:200, fontSize:'0.95em', padding:'6px'}}
            required
          />
          <button
